        ...
        <nav>
            ...
            <div class="smMenu">
                <div class="hmburgMenu">
                    <span onclick="openAsideMenu()"><svg xmlns="http://www.w3.org/2000/svg" height="44px"
                            viewBox="0 -960 960 960" width="44px" fill="#FFFFFF">
            ...
            <div class="asideMenu">
                <div class="closeBtn">
                    <span onclick="closeAsideMenu()"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                ...
                <ul>
                    <li><a href="#">Ready To Ship PCs</a></li>
                    <li>
                        <span><a href="#">Custom PCs</a></span>
                        <ul>
                            <li><a href="#">Small Form Facto</a></li>
                            <li><a href="#">Full Tower</a></li>
                            <li><a href="#">Watercooled</a></li>
