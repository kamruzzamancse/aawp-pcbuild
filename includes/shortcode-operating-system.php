   ...
   /*  $transient_key = 'aawp_pcbuild_' . md5($category);
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Extract numeric prices from the 4th column (Price)
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function sortTableByKey(key, direction) {
                ...
                rows.sort((a, b) => {
                    ...
                    return direction === 'asc' ? parsedA.localeCompare(parsedB) : parsedB.localeCompare(parsedA);
                });
            ...
            function parseValue(value, key) {
                switch (key) {
                    ...
                    case 'boost_clock':
                        return parseFloat(value.replace(/[^0-9.]/g, '')) || 0;
                    case 'name':
                        return value.toLowerCase(); // case-insensitive title sort
                    default:
                        return value;
                }
            }
